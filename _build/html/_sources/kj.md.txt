...
1. 负债的定义
   ...
   - 负债是企业承担的现时义务；现时义务：是指企业在现行条件下已承担的义务。

   - 负债的清偿预期会导致经济利益流出企业；（现金、实物资产、提供劳务、转为资本等）
...
1. 收入的定义：收入是指企业在日常活动中形成的、会导致所有者权益增加的、与所有者投入资本无关的经济利益的总流入。根据收入的定义，收入具有以下几个方面的特征：
   - 收入应当是企业在日常活动中形成的（营业外收入不确认为收入）
   - 收入是与所有者投入资本无关的经济利益的总流入
   - 收入会导致所有者权益的增加

2. 收入的确认条件：收入在确认时除了应当符合收入定义外，至少应当符合以下条件：
   - 与收入相关的经济利益很可能流入企业
...
1. 费用的确认条件，费用在确认时除了应当符合收入定义外，费用的确认至少应当符合以下条件：
   - 与费用相关的经济利益应当很可能流出企业；
...
3. 利润的确认条件：利润反映的是收入减去费用、利得减去损失后的净额，因此，利润的确认主要依赖于收入和费用以及利得和损失的确认，其金额的确定也主要取决于收入、费用、利得、损失金额的计量。
...
- 原则是指按照企业会计准则规定的、适合于企业会计核算所采用的具体会计原则
- 基础是指为了将会计原则应用于交易或者事项而采用的基础，主要是计量基础（即计量属性），包括历史成本、-置成本、可变现净值、现值和公允价值等
...
3. 会计政策的层次性（包括会计原则、计量基础和会计处理方法三个层次）
   ...
   【特别提示】企业应当披露重要的会计政策，不具有重要性的会计政策可以不予披露。
...
【特别提示】企业应当披露重要的会计估计，不具有重要性的会计估计可以不披露。
...
【特别提示】根据会计确认、计量基础和列报项目所选择的、为取得与资产负债表项目有关的金额或数值（如预计使用寿命、净残值等）所采用的处理方法，不是会计政策，而是会计估计，其相应的变更是会计估计变更。
...
2. 比较财务报表的追溯调整
   ...
   - 对于比较财务报表可比期间以前的会计政策变更的累积影响数应调整比较财务报表最早期间的期初留存收益，财务报表其他相关项目的数字也应一并调整。

   【特别提示】资产负债表调整变化年度的年初数，利润表调整变化年度的上年数。
...
4. 会计政策变更累积影响数的含义
   ...
   【特别提示】上述留存收益金额，包括盈余公积和未分配利润等项目，不考虑由于损益的变化而应当补分的利润或股利。
...
5. 会计政策变更累积影响数的计算步骤
   ...
   【特别提示】对以前年度损益进行追溯调整或追溯重述的，应当重新计算各列报期间的每股收益。
...
【特别提示】在未来适用法下，不需要计算会计政策变更产生的累积影响数，也无须重编以前年度的财务报表。
...
【特别提示】在以后期间的财务报表中，不需要重复披露在以前期间的附注中已披露的会计政策变更的信息。
...
2. 会计估计变更既影响变更当期又影响未来期间的，其影响数应当在变更当期和未来期间予以确认。（固定资产的折旧年限）。会计估计变更的影响数应计入变更当期与前期相同的项目中。
...
处理原则：企业不需要调整财务报表相关项目的期初数，但应当调整发现当期与前期相同的相关项目。（视同本期发生，科目正常写，无需调整期初数）

（二）重要的前期差错 ：是指足以影响财务报表使用者对企业财务状况、经营成果和现金流量作出正确判断的前期差错
...
3. 对于年度资产负债表日至财务报告批准报出日之间发现的报告年度的会计差错及报告年度前不重要的前期差错，应按照《企业会计准则第29号——资产负债表日后事项》的规定进行处理，对于重要的前期差错，企业应当在其发现当期的财务报表中，调整前期比较数据。   具体地说，企业应当在重要的前期差错发现当期的财务报表中，通过下述处理对其进行追溯更正：
...
4. 应交所得税
   ...
   如果会计准则和税法对涉及损益的事项处理口径一致（即税法允许调整应交所得税），则应考虑应交所得税的调整；（销售退回）

   如果会计准则和税法对涉及损益的事项处理口径不一致（即税法不允许调整应交所得税），则不应考虑应交所得税的调整。（坏账准备）

5. 递延所得税

   重要的前期差错更正涉及损益的事项是否要进行递延所得税的会计处理，主要与重要的前期差错更正是否会涉及暂时性差异有关。

   - 如果重要的前期差错更正涉及暂时性差异，应分别应纳税暂时性差异与可抵扣暂时性差异，确认相关的递延所得税负债与递延所得税资产，并在此基础上确定利润表中的所得税费用。
   - 如果重要的前期差错更正未引起暂时性差异，则无需进行递延所得税的会计处理
...
1. 自营方式建造固定资产（自己买料、自己盖房）
   ...
   - 盘亏、报废、毁损的工程物资，减去残料价值（原材料）以及保险公司、过失人等赔款（其他应收款）后的差额：（★★3种情形）（盘盈：原理类似）
      ①工程项目尚未完工的，计入或冲减工程项目的成本；
      ②工程项目已经完工的，计入当期营业外收入或营业外支出。
      ③非常原因造成的工程物资的盘亏、报废、毁损，直接计入营业外支出。

   - 所建造的固定资产已达到预定可使用状态，但尚未办理竣工结算的，应当自达到预定可使用状态之日起，根据工程预算、造价或者工程实际成本等，按暂估价值转入固定资产，并按有关计提固定资产折旧的规定，计提固定资产折旧。待办理竣工决算手续后再调整原来的暂估价值（追溯调整），但不需要调整原已计提的折旧额。（会计估计变更：未来适用法）
...
1. 其他方式取得的固定资产的成本
   ...
   - 投资者投入的固定资产的成本。投资者投入的固定资产的成本，应当按照投资合同或协议约定的价值确定，但合同或协议约定价值不公允的除外。
...
2. 转换日
   ...
   - “自用房地产或存货”转换为“投资性房地产”：租赁期开始日或用于资本增值的日期。“空置建筑物或在建建筑物”是董事会或类似机构作出书面决议的日期。
...
1. 资产支出已经发生：包括支付现金、转移非现金资产和承担带息债务形式发生的支出，赊购形式发生的支出不属于资产支出。
2. 借款费用已经发生：已经发生了专门借款费用或者占用了一般借款的借款费用。
3. 为使资产达到预定可使用或者可销售状态所必要的购建或者生产活动已经开始：是指符合资本化条件的资产的实体建造或者生产工作已经开始       |
...
1. 正常中断：中断是资产达到预定可使用或者可销售状态必要的程序、可预见的不可抗力导致中断为正常中断
   - 正常测试、调试停工；
   - 东北因冬季无法施工停工等
2. 非正常中断：是指企业管理决策上的原因或者其他不可预见的原因等所导致的中断
   - 企业因与施工方发生了质量纠纷；
   - 工程、生产用料没有及时供应；
   - 资金周转发生了困难；
   - 施工、生产发生了安全事故；
...
1. 后续支出金额很少；
1. 试生产出合格产品；
1. 分别建造、分别完工的资产，如果完工部分能够独立使用或销售，完工部分借款费用应当停止资本化；
1. 分别建造、分别完工的资产，必须等到整体完工后才可使用或者可对外销售的，应当在该资产整体完工时停止借款费用的资本化。
...
1. 资本化利息费用
   ...
   - 资本化利息费用金额=资本化期间专门借款本金发生的利息金额-资本化期间闲置资金的投资收益或利息收入（与专门借款的具体支出数无关，资本化期间发生的全部利息费用均资本化）
   - 资本化利息费用金额=累计资产支出超过专门借款部分的资产支出加权平均数×一般借款资本化率

2. 费用化利息费用：

   - 费用化利息费用金额=费用化期间专门借款本金发生的利息金额-费用化期间闲置资金的投资收益或利息收入
   - 费用化利息费用金额=一般借款利息总额－一般借款资本化利息费用－一般借款闲置资金的投资收益或利息收入（闲置资金收益全部冲减费用化利息费用金额）
...
2. 业绩条件
   ...
   - 市场条件是指行权价格、可行权条件以及行权可能性与权益工具的市场价格相关的业绩条件，如股份支付协议中关于股价上升至何种水平职工或其他方可相应取得多少股份的规定。
...
1. 前期已合理计提：直接计入或冲减当期营业外支出
2. 前期未合理计提：按照重大差错更正的方法进行会计处理
3. 前期无法合理预计，未计提：在该损失实际发生的当期，直接计入营业外支出
...
3. 以公允价值计量且其变动计入其他综合收益的金融资产（权益工具）公允价值变动（综股）。
...
3. 采用权益法核算的长期股权投资
   ...
   借：长期股权投资——其他综合收益
   贷：其他综合收益（被投资单位其他综合收益减少作相反的会计分录）。
...
1. 与资产相关的政府补助：是指企业取得的、用于购建或以其他方式形成长期资产的政府补助。有两种处理方法可供选择
...
1. 一是总额法，将政府补助全额确认为收益；
2. 二是净额法，将政府补助作为相关资产账面价值或所补偿费用的扣减。
   - 与企业日常活动相关的政府补助，应当按照经济业务实质，计入其他收益或冲减相关成本费用。通常情况下，若政府补助补偿的成本费用是营业利润之中的项目，或该补助与日常销售行为密切相关如增值税即征即退等，则认为该政府补助与日常活动相关。
   - 与企业日常活动无关的政府补助，计入营业外收支。如自然灾害的补助等。
...
1. 总额法
   ...
   - 需要说明的是，采用总额法的，如果应的长期资产在持有期间发生减值损失递延收益的摊销仍保持不变，不受减值素的影响。企业对与资产相关的政府补选择总额法核算的，应当将递延收益分转入其他收益或营业外收入，借记“递延收益”科目，贷记“其他收益”或“营业外入”科目。相关资产在使用寿命结束时或束前被处置（出售、报废、转让、发生损等），尚未分配的相关递延收益余额当转入资产处置当期的损益，不再予以延。对相关资产划分为持有待售类别的先将尚未分配的递延收益余额冲减相关产的账面价值，再按照《企业会计准则42号——持有待售的非流动资产、处置组终止经营》的要求进行会计处理。
...
综合性项目政府补助同时包含与资产相关的政府补助和与收益相关的政府补助，企业需要将其进行分解并分别进行会计处理；难以区分的，企业应当将其**整体归类为与收益相关的政府补助**进行处理。
...
1. 债务人的会计处理
   ...
   - 非现金资产为固定资产、无形资产的，其公允价值和账面价值的差额，计入资产处置损益。
...
1. 货币性项目
   ...
   - 期末调整
     ...
     期末，将所有外币货币性项目的外币余额，按照期末即期汇率折算为记账本位币金额，并与原记账本位币金额相比较，其差额记入“财务费用——汇兑差额”等科目；
       ...
       1. 调整后记账本位币余额=期末外币余额×期末即期汇率
       1. 汇兑差额=调整后记账本位币余额-调整前记账本位币余额
...
2. 非货币性项目
   ...
   非货币性项目，是指货币性项目以外的项目。例如，存货、长期股权投资、交易性金融资产（股票、基金）、固定资产、无形资产等。【提示】预付款项、预收款项和合同负债属于非货币性项目。
...
1. 资产负债表日后因自然灾害导致资产发生重大损失；
1. 资产负债表日后发行股票和债券以及其他巨额举债；
1. 资产负债表日后资本公积转增资本；
1. 资产负债表日后发生巨额亏损；
1. 资产负债表日后发生企业合并或处置子公司。
1. 资产负债表日后企业利润分配方案中拟分配的以及经审议批准宣告发放的现金股利和利润。
...
1. 分类原则
   ...
   - 可立即出售：根据类似交易中出售此类资产或处置组的惯例，在当前状况下即可立即出售。
...
每股收益是指普通股股东每持有一股普通股所能享有的企业净利润或需承担的企业净亏损。包括基本每股收益和稀释每股收益两类。
...
$$
稀释每股收益=\frac{净利润+可转债税后实际利息}{普通股加权平均数+可转债转股数\times存续月数/12}
$$
...
2. 调整系数=配股前股份/每股理论除权价格
3. 因配股重新计算的上年度基本每股收益=上年度基本每股收益/调整系数
4. 本年度基本每股收益=当期净利润/（配股前股数×调整系数×配股前的时间权重＋配股后股数x配股后时间权数）
...
企业应当在利润表中单独列示基本每股收益和稀释每股收益。应当在附注中披露与每股收益有关的下列信息：
...
1. 有序交易的确定：企业在确定一项交易是否为有序交易时，应当全面理解交易环境和有关事实。
...
- 关联方之间的交易；
- 被迫进行的交易，或者资产出售方（或负债转移方）在交易中被迫接受的交易；
- 交易价格所代表的计量单元不同于以公允价值计量的相关资产或负债的计量单元。例如，以公允价值计量的相关资产或负债仅是交易（例如，企业合并）中的一部分，而交易除该资产或负债外，还包括按照其他会计准则应单独计量但未确认的无形资产；
...
1. 现金流量折现法。现金流量折现法是企业在收益法中最常用到的估值方法，包括传统法（即折现率调整法）和期望现金流量法。为避免重复计算或忽略风险因素的影响，折现率与现金流量应当保持一致。
...
企业可**使用出价计量资产头寸、使用要价计量负债头寸**，也可使用市场参与者在实务中使用的在出价和要价之间的中间价或其他定价惯例计量相关资产或负债。但是，企业不应使用与公允价值计量假定不一致的方法，例如对资产使用要价，对负债使用出价。
...
公允价值计量结果所属的层次，由对公允价值计量整体而言重要的**输入值所属的最低层次**决定。
...
1. 固定资产
   ...
   - 计税基础：实际成本-税法累计折旧
2. 无形资产
   - 账面价值：实际成本-会计累计摊销-减值准备，使用寿命不确定则无摊销
   - 计税基础：
      - 自行研发：账面价值*1.75。
      - 其它方式：实际成本-税法累计摊销
3. 以公允价值计量的金融资产
...
应交税费-应交所得税=（税前会计利润+纳税调增额-纳税调减额）X税率
...
4. 计算所得税费用：
   ...
   所得税费用=应交所得税+递延所得税负债发生额对应损益部分-递延所得税资产发生额对应损益部分
...
1. 收入确认原则：客户取得相关商品控制权时确认收入。取得商品控制权包括以下三要素：
...
4. 合同变更
   ...
   - 情况三：合同变更部分作为原合同组成部分
      ...
      - 不属于情况一，且合同变更日已转商品和未转商品不可明确区分，应将该合同变更部分作为原合同组成部分，在合同变更日重新计算履约进度，并调整当期收入和相应成本等（属于会计估计变更）
...
1. 交易价格分摊
   ...
   按各单项履约义务所承诺商品的单独售价的相对比例分摊。单独售价的确定方法：
...
4. 交易价格后续变动
   ...
   - 特殊情况：合同变更导致的交易价格后续变动，分三种情况处理：
     - 情况一：应当判断可变对价后续变动与哪一项合同相关，并按相关规定进行处理。
     - 情况二：且可变对价后续变动与合同变更前已承诺的可变对价相关的，应当首先将该可变对价后续变动额以原合同开始日确定的单独售价为基础进行分摊，然后再将分摊至合同变更日尚未履行义务的该可变对价额以新合同开始日确定的基础进行二次分摊。
...
1. 按时段确认收入
   ...
   - 收入确认方法：
     ...
     - 确定方法：
        ...
        1. 产出法：根据已转移给客户的商品对于客户的价值确定履约进度。
        1. 投入法：根据企业履约的投入确定履约进度。特殊情况需要适当调整。
...
3. 使用积分时
   ...
   ```text
   借：合同负债
   贷：主营业务收入（金额=积分分摊的成交金额X当期使用/预计总共兑换）
   ```
...
1. 情况一：存在与客户的远期安排而负有回购义务或享有回购权利的，应作为租赁交易或融资交易处理
   ...
   - 回购价格小于原售价的：应当作为租赁交易，原售价减去回购价之差，视为租金，按租赁准则处理。
   - 回购价格不小于原售价的：应当作为融资交易，收的款项时确认金融负债，收款与回购价的差额在回购期间内确认为利息费用等。
   - 到期不行权的：在该回购权利到期时终止确认金融负债，同时确认收入。
...
2. 以公允价值计量且其变动计入其它综合收益的金融资产（FVOCI）
   ...
   - 现金流特征：本金+利息
   - 核算科目：其他债权投资
   - 特殊情况：非交易性权益工具投资（业务模式为长期持有、获取稳定分红、不关心价格波动），直接指定为本类资产。一经指定，不得撤销。后续处理：
      - 公允价值的后续变动计入OCI。
      - 不计提减值准备。
...
3. FVPL重分类
   ...
   - 重分类为摊余成本计量：应当以其在重分类日的公允价值作为新的账面余额。
   - 重分类为FVOCI：应当继续以公允价值计量。
...
1. 权益工具重分类为金融负债：金融负债按公允价值计算，权益工具账面价值与金融负债公允价值的差额确认为权益。

2. 金融负债重分类为权益工具：权益工具按重分类日金融负债的账面价值计量。
...
1. 公允价值套期：是指对已确认资产或负债、尚未确认的确定承诺，或上述项目组成部分的公允价值变动风险敞口进行的套期。
   1. 如签订一项以固定利率换浮动利率的利率互换合约。
   2. 比如签订了6个月后固定价格购买商品的合约，同时签订了未来卖出商品的期货合约。

2. 现金流量套期：是指对源于已确认的资产或负债、极可能发生的预期交易，或与上述项目组成部分有关的特定现金流量风险敞口进行的套期。
3. 境外经营净投资套期
...
1. 应当将符合条件的金融工具整体指定为套期工具，下列除外：
   - 对于期权，可将期权的内在价值和时间价值分开，只将期权的内在价值变动指定为套期工具。
...
指使企业面临公允价值或现金流量变动风险，且被指定为被套期对象的、能够可靠计量的项目。企业可以将下列单个项目、项目组合或其组成部分指定为被套期项目：
...
2. 合并范围的豁免——投资性主体：
   - 如果母公司是投资旆主体，只合并为其投资活动提供相关服务的子公司。对其他子公司应当按公允价值计量且变动计入当期损益。
...
2. 调整投资损益（调利润）
   ...
   - 取得长投后，未实现内部交易损益调整：内部交易应予以抵销。未实现部分影响净利润。
...
3. 取得现金股利或利润的处理：权益法下取得的现金股利冲减长期股权投资成本，不确认投资收益，所以不影响投资企业利润。因为被投资企业在实现利润时，已经确认了投资收益，所以无需再资确认。而利润分配时，经济利益是流出企业的，所以是减少长投的价值。
...
5. 其他综合收益的处理：被投资单位确认的其他综合收益及变动，也会影响投资企业所占份额：
   ...
   - 常见调整领域：
      - 房地产非转投时，公允价值高出账面差额计入“其他综合收益”（注意：投资性房地产由成本法转公允价值法时，属于会计政策变更，影响留存收益）
      - FVOCI公允价值发生变动时。
...
4. 通过多次交易分步实现非同控（个表）
   - 原投资为长股：购买日长投初始成本=原投资账面价值+新增股份公允价值（原持有的长投因权益法形成的OCI暂不处理，待到处置时再进行处理）
   - 原投资为金融资产：购买日长投初始成本=原投资公允价值+新增股份公允价值
...
2. 确定购买日：同时满足：一系列一看就明白的条件。

3. 确定企业合并成本：如前述，反复强调公允价值。

##### （二）非同控取得子公司购买日合并报表编制

1. 初始确认：一般来说合表确认的长投与个别确认的一致。特殊情况是多次购买形成控股合并时，会存在差异。
...
注意：如果子公司出玑净资产为负数，少数股东按比例承担亏损。即少数股东权益可能出现负数。
...
2. 合表：长投初始成本为，原权益法下转换日长投的公允价值加上新增投资所付的公允价值。
   - 账面和公允的差额计入“投资收益”，但这个投资收益不反应在个表中，而是反映在合表中。
   - 权益法下长投的OCI在个表中不转入“投资收益”，但在合表中要转入投资收益。
...
2. 如果不属一揽子交易，在合表中，对于购买日之前持有的股权，应当按该股权在购买日的公允价值重新计算，公允与账面价值差计入当期投资收益。
   ...
   - 个表：长投成本为原股份的账面价值加上新增投资的公允价值。
   - 合表：合并成本为原股份的公允价值加上新增投资的公允价值。合表需要确认两笔投资收益：公允账面差确认投资收益，其他综合收益转入投资收益。
...
1. 个表：按照收到的价款跟处置的长投成本作比较，确认投资收益。

2. 合表：不确认损益，不影响商誉。差额调整资本公积，不足冲减留存收益。
...
2. 多次交易分步处置子公司
   ...
   - 属于一揽子交易：将各交易作为一项处置原子公司并丧失控制权的交易进行处理。对于丧失控制权之前的每一次交易，价款与持续计算净资产账面份额差，在合表中应当计入其他综合收益，在丧失控制权时一并转入丧失控制权当期的损益。
...
2. 该份额与增资后的份额之差，在合表中计入资本公积，不足则冲减留存收益。
